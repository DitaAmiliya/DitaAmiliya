...
map.getView().fit([12152705.906470, -875578.732471, 12250531.352604, -830109.511790], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Geologi Kabupaten Kebumen</h2>';
        return titleElement;
    })(),
